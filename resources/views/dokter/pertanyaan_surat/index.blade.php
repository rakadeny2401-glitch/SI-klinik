...
@section('content')
<div class="w-full p-6 md:p-8 font-sans bg-gray-50/30 min-h-screen flex items-center justify-center relative">

    {{-- TOAST BANNER BERHASIL (Melayang di tengah atas layar sesuai contoh gambar) --}}
    @if(session('success'))
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl border border-gray-100 p-8 md:p-12 shadow-[0_4px_25px_rgba(0,0,0,0.015)] text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            ...
            {{-- TOMBOL SURAT REKOMENDASI RUJUKAN (Biru Tua) --}}
            @if(!$rujukanSudahAda)
            ...
            {{-- TOMBOL SURAT KETERANGAN SAKIT (Hijau Medis) --}}
            ...
            {{-- TOMBOL KEMBALI KE DAFTAR PASIEN (Abu-abu Netral) --}}
