...
<div style="font-family: 'Nunito', sans-serif; padding: 30px; background: #fff; border-radius: 12px; max-width: 900px; margin: 20px auto;">
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid #e2f0fd; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
        ...
        <tr>
            <th style="background-color: #0b438c; color: white; padding: 15px; text-align: left; font-size: 14px; border-bottom: 1px solid #08336d;">Keterangan</th>
            <td style="padding: 15px; border-bottom: 1px solid #e2f0fd; font-size: 14px; color: #333; line-height: 1.6;">{{ $data->keterangan }}</td>
        </tr>
        <tr>
            <th style="background-color: #0b438c; color: white; padding: 15px; text-align: left; font-size: 14px; border-bottom: 1px solid #08336d;">Jumlah Istirahat</th>
            <td style="padding: 15px; border-bottom: 1px solid #e2f0fd; font-size: 14px; color: #333;">{{ $data->jml_istirahat }} hari</td>
        </tr>
        <tr>
            <th style="background-color: #0b438c; color: white; padding: 15px; text-align: left; font-size: 14px; border-bottom: 1px solid #08336d;">Tanggal Mulai</th>
            <td style="padding: 15px; border-bottom: 1px solid #e2f0fd; font-size: 14px; color: #333;">{{ $data->tgl_mulai }}</td>
        </tr>
        <tr>
            <th style="background-color: #0b438c; color: white; padding: 15px; text-align: left; font-size: 14px; border-bottom: 1px solid #08336d;">Tanggal Selesai</th>
            <td style="padding: 15px; border-bottom: 1px solid #e2f0fd; font-size: 14px; color: #333;">{{ $data->tgl_selesai }}</td>
        </tr>
        <tr>
