...
<div class="w-full p-6 md:p-8 font-sans bg-gray-50/30 min-h-screen">
    ...
    <div class="max-w-[850px] w-full mx-auto bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.012)]">
        ...
        {{-- Kotak Pembungkus dengan Efek Legend Melayang --}}
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full border-collapse text-sm m-0">
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/40 transition-colors">
                            <th class="py-3.5 pr-4 text-left font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap vertical-align-top pt-3.5">Keterangan Sakit</th>
                            <td class="py-3.5 px-2 text-gray-900 font-medium leading-relaxed italic">: "{{ $data->keterangan }}"</td>
                        </tr>
                        <tr class="hover:bg-gray-50/40 transition-colors">
                            <th class="py-3.5 pr-4 text-left font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Lama Istirahat</th>
                            <td class="py-3.5 px-2 text-emerald-700 font-bold">: {{ $data->jml_istirahat }} Hari</td>
                        </tr>
                        <tr class="hover:bg-gray-50/40 transition-colors">
                            <th class="py-3.5 pr-4 text-left font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Mulai Tanggal</th>
                            <td class="py-3.5 px-2 text-gray-700 font-medium">: {{ date('d F Y', strtotime($data->tgl_mulai)) }}</td>
                        </tr>
                        <tr class="hover:bg-gray-50/40 transition-colors">
                            <th class="py-3.5 pr-4 text-left font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Sampai Tanggal</th>
                            <td class="py-3.5 px-2 text-gray-700 font-medium">: {{ date('d F Y', strtotime($data->tgl_selesai)) }}</td>
                        </tr>
                        <tr class="hover:bg-gray-50/40 transition-colors">
                            <th class="py-3.5 pr-4 text-left font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Dokter Berwenang</th>
